...
--
-- Host: 127.0.0.1
-- Generation Time: 25-Maio-2017 às 02:38
...
(2, 'Cueca Veia', '963', 5, 'Inglês'),
(3, 'cubanacam', '741', 4, 'portugues'),
(4, 'ZE ruela', '7412', 5, 'portugues'),
(5, 'Romeu e julieta', '3698', 5, 'portugues'),
(6, 'Alibaba', '745', 5, 'portugues'),
(7, 'Hardware', '6988', 5, 'Inglês');
...
('528c0cb43e0202b409b91329c12b3656', '::1', 'Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36', 1495679343, 'a:5:{s:9:"user_data";s:0:"";s:4:"nome";s:14:"André Pedroso";s:2:"id";s:1:"1";s:9:"permissao";s:1:"1";s:6:"logado";b:1;}');
...
INSERT INTO `emprestimos` (`idEmprestimos`, `dataEmprestimo`, `dataDevolucao`, `dataVencimento`, `leitores_id`, `usuarios_id`, `status`, `grupo_id`, `qtde_item`, `qtde_renovacao`) VALUES
(53, '2017-05-25', '0000-00-00', '2017-06-01', 4, 1, 'Renovado', 1, 1, 1);
...
INSERT INTO `itens_de_emprestimos` (`idItens`, `emprestimos_id`, `acervos_id`, `quantidade`) VALUES
(73, 53, 3, 0);
...
(1, 'André Pedroso', '600.021.520-87', 'admin@admin.com', 'd033e22ae348aeb5660fc2140aec35850c4da997', '(19)3863-4433', '', 1, '2013-11-22', 1),
...
--
ALTER TABLE `acervos`
  MODIFY `idAcervos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `emprestimos`
  MODIFY `idEmprestimos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
--
...
--
ALTER TABLE `itens_de_emprestimos`
  MODIFY `idItens` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=74;
--
